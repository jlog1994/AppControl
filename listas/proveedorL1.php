<head>
	...
	<div data-role="content">
	   	...
	   	?>
	   	   ...
	   	   <li><?php echo '<a target="cont" href="modproveedor.php?nc='.$row["id"].'">';?>
	   	      <img src="<?php if($row["foto"]==NULL){echo 'images/c.png';}
	   	      else {echo 'mostrarfoto.php?nc='.$row["ncontrol"];}?>" width="50" heigth="55"/>
	   	      <h3><?php echo $row["ref_direccion"];?></h3>
	   	      <p>C.P <?php echo $row["ref_datos"];?></p>
	   	      </a>
	   	      <a ref="#purchase" data-rel="popup" data-position-to="window"
	   	      data-transition="pop"><?php echo $row["ref_direccion"]?></a>
	   	      </li>
	   	      <?php } ?>
	   	      </ul>
